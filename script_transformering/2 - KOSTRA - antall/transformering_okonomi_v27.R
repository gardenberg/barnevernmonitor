...
tabell_27_kommune <- read_delim("datauttrekk_raw/tabell_27_kommune.csv", ";", escape_double = FALSE, 
...
tabell_27_bydel <- read_delim("datauttrekk_raw/tabell_27_bydel.csv", ";", escape_double = FALSE, 
...
temp = select(tabell_27_kommune, Region = KOKkommuneregion0000, Tid, Value = value) %>%
  bind_rows(., select(tabell_27_bydel, Region = KOKbydelsregion0000, Tid, Value = value))
...
temp = mutate(temp, 
              Variabel = "v27_barn_022_251_ilaaar",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v27_barn_022_251_ilaaar.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_27_bydel, tabell_27_kommune,
