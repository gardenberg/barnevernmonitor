...
# TIL 2E - Andel av kommunens totale utgifter som brukes på barnevern
...
tabell_25_kommune <- read_delim("datauttrekk_raw/tabell_25_kommune.csv", ";", escape_double = FALSE, 
                               col_types = cols(KOKkommuneregion0000 = col_character(),
                                                KOKartkap0000 = col_character(),
...
tabell_25_bydel <- read_delim("datauttrekk_raw/tabell_25_bydel.csv", ";", escape_double = FALSE, 
...
temp = select(tabell_25_kommune, Region = KOKkommuneregion0000, Tid, Value = value) %>%
  bind_rows(., select(tabell_25_bydel, Region = KOKbydelsregion0000, Tid, Value = value))
...
temp = mutate(temp, 
              Variabel = "v25_netto_driftsutgifter_totalt_kommunen_1000kr",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v25_netto_driftsutgifter_totalt_kommunen_1000kr.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_25_bydel, tabell_25_kommune,
