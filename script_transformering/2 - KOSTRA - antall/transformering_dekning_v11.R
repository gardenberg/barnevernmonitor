...
tabell_11_kommune <- read_delim("datauttrekk_raw/tabell_11_kommune.csv", ";", escape_double = FALSE, 
...
tabell_11_bydel <- read_delim("datauttrekk_raw/tabell_11_bydel.csv", ";", escape_double = FALSE, 
...
temp = mutate(temp, 
              Variabel = "v11_stillinger_saksbehandling_admin_244",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v11_stillinger_saksbehandling_admin_244.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_11_bydel, tabell_11_kommune,
