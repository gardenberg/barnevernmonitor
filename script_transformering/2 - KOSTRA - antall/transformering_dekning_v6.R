...
tabell_6_kommune <- read_delim("datauttrekk_raw/tabell_6_kommune.csv", ";", escape_double = FALSE, 
...
tabell_6_bydel <- read_delim("datauttrekk_raw/tabell_6_bydel.csv", ";", escape_double = FALSE, 
...
temp = select(tabell_6_kommune, Region = KOKkommuneregion0000, Tid, Value = value) %>%
  bind_rows(., select(tabell_6_bydel, Region = KOKbydelsregion0000, Tid, Value = value))
...
temp = mutate(temp, 
              Variabel = "v6_barn_tiltak_ilaaret_252_0_17",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v6_barn_tiltak_ilaaret_252_0_17.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_6_bydel, tabell_6_kommune,
