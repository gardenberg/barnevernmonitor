...
tabell_18_kommune <- read_delim("datauttrekk_raw/tabell_18_kommune.csv", ";", escape_double = FALSE, 
...
tabell_18_bydel <- read_delim("datauttrekk_raw/tabell_18_bydel.csv", ";", escape_double = FALSE, 
...
temp = select(tabell_18_kommune, Region = KOKkommuneregion0000, Tid, Value = value) %>%
  bind_rows(., select(tabell_18_bydel, Region = KOKbydelsregion0000, Tid, Value = value))
...
temp = mutate(temp, 
              Variabel = "v18_barn_022_undersokelse_tiltak_ilaaar",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v18_barn_022_undersokelse_tiltak_ilaaar.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_18_bydel, tabell_18_kommune,
