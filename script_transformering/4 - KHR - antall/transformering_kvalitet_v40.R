...
# 3F - Barn i hjelpetiltak med evaluert tiltaksplan 
#40	Antall Barn i hjelpetiltak med evaluert tiltaksplan 	KHR-kuben
...
tabell_40 <- read_delim("data_manuelle_leveranser/KHR - tabell 40-41-42 uttrekk fra KHR til barnevernsmonitor 1-mars-2021.csv", ";", escape_double = FALSE, 
                        col_types = cols(Rapporteringsenhet = col_character(),
                                         `År` = col_character(), 
                                         `Halvår` = col_character(),
                                         `Tiltak Barn Med  Tiltaksplan §4-4 Sammenh 3mnd` = col_skip(),
                                         `Tiltak Barn Med  Tiltaksplan §4-4 Sammenh 3mnd Evaluert Siste Halvår` = col_number()),
...
temp = mutate(temp, 
              Variabel = "v40_antall_barn_hjelpetiltak_evaluert_tiltaksplan",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v40_antall_barn_hjelpetiltak_evaluert_tiltaksplan.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_fylkesnr_gyldighet, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_40, 
