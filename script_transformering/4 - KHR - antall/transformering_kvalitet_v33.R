...
##33	Antall Tilsynskrav i fosterhjem som ikke er oppfylt	KHR-kuben
...
tabell_33 <- read_delim("data_manuelle_leveranser/KHR - tabell 32-321-33 uttrekk fra KHR til barnevernsmonitor 1-mars-2021.csv", ";", escape_double = FALSE, 
                        col_types = cols(Rapporteringsenhet = col_character(),
                                         `År` = col_character(), 
                                         `Halvår` = col_character(),
                                         `Fosthj Barn Plassert Mer Enn 1 År Tilsynskrav Ikke Oppfylt` = col_number(),
                                         `Fosthj Barn Tilsyn Plassert Mer Enn 1 År` = col_skip(),
...
temp = mutate(temp, 
              Variabel = "v33_antall_tilsynskrav_fosterhjem_ikke_oppfylt",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v33_antall_tilsynskrav_fosterhjem_ikke_oppfylt.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_fylkesnr_gyldighet, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_33, 
