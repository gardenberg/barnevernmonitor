...
#361	Antall barn i fosterhjem med krav på oppfølging	KHR-kuben
...
tabell_361 <- read_delim("data_manuelle_leveranser/KHR - tabell 36-361-37 uttrekk fra KHR til barnevernsmonitor 1-mars-2021.csv", ";", escape_double = FALSE, 
                        col_types = cols(Rapporteringsenhet = col_character(),
                                         `År` = col_character(), 
                                         `Halvår` = col_character(),
                                         `Fosthj Barn Oppf- Og Kontroll Plassert Mer Enn 1 År Besøk Ikke Oppfylt` = col_skip(),
                                         `Fosthj Barn Oppf- Og Kontrollansv Plassert Mer Enn 1 År` = col_number(),
...
temp = mutate(temp, 
              Variabel = "v361_antall_oppfolging_kontroll_fosterhjem",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v361_antall_oppfolging_kontroll_fosterhjem.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_fylkesnr_gyldighet, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_361, 
