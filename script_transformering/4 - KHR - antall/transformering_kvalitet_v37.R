...
#37	Antall Barn i fosterhjem som ikke har fått oppfølging i tråd med lovkrav	KHR-kuben
# 3D Barn i fosterhjem som ikke har fått oppfølging i tråd med lovkrav
...
tabell_37 <- read_delim("data_manuelle_leveranser/KHR - tabell 36-361-37 uttrekk fra KHR til barnevernsmonitor 1-mars-2021.csv", ";", escape_double = FALSE, 
                        col_types = cols(Rapporteringsenhet = col_character(),
                                         `År` = col_character(), 
                                         `Halvår` = col_character(),
                                         `Fosthj Barn Oppf- Og Kontroll Plassert Mer Enn 1 År Besøk Ikke Oppfylt` = col_number(),
                                         `Fosthj Barn Oppf- Og Kontrollansv Plassert Mer Enn 1 År` = col_skip(),
                                         `Fosthj Andel barn oppf- og kontroll plassert mer enn 1 år besøk ikke oppfylt` = col_skip()),
...
temp = mutate(temp, 
              Variabel = "v37_antall_oppfolging_kontroll_fosterhjem_ikke_oppfylt",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v37_antall_oppfolging_kontroll_fosterhjem_ikke_oppfylt.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_fylkesnr_gyldighet, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_37, 
