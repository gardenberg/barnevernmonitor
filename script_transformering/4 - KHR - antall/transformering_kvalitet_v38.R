...
#38	Antall Barn i hjelpetiltak med tiltaksplan (2019)	KHR-kuben
# 3E - Barn i hjelpetiltak med tiltaksplan
...
tabell_38 <- read_delim("data_manuelle_leveranser/KHR - tabell 38-381-39 uttrekk fra KHR til barnevernsmonitor 1-mars-2021.csv", ";", escape_double = FALSE, 
                        col_types = cols(Rapporteringsenhet = col_character(),
                                         `År` = col_character(), 
                                         `Halvår` = col_character(),
                                         `Tiltak Barn Hjtilt Med Tiltaksplan §4-5` = col_number(),
                                         `Tiltak Barn Hjtilt § 4-4 Tot` = col_skip(),
                                         `Tiltak Andel barn hjtilt (§4-4) med tiltaksplan` = col_skip()),
...
temp = mutate(temp, 
              Variabel = "v38_antall_barn_hjelpetiltak_tiltaksplan",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v38_antall_barn_hjelpetiltak_tiltaksplan.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_fylkesnr_gyldighet, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_38, 
