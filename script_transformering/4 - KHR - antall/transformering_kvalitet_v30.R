...
##30	Antall Fristbrudd i undersøkelsessaker 	KHR-kuben
#TIL 3A - Fristbrudd i undersøkelsessaker (antall og andel)

#ANTALL - KHR

#opprettet 1. mars 2021
#versjon 001
...
tabell_30 <- read_delim("data_manuelle_leveranser/KHR - tabell 30-301-31 uttrekk fra KHR til barnevernsmonitor 26-februar-2021.csv", ";", escape_double = FALSE, 
                        col_types = cols(Rapporteringsenhet = col_character(),
                                         `År` = col_character(), `Halvår` = col_character(),
                                         `Unders Avsl Siste Halvår` = col_skip(),
...
temp = mutate(temp, 
              Variabel = "v30_antall_fristoverskridelser",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v30_antall_fristoverskridelser.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_fylkesnr_gyldighet, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_30, 
