...
#4C - Andel i befolkningen med utdanning utover grunnskole
#50	Antall i befolkningen med utdanning utover grunnskole	https://www.ssb.no/statbank/table/09434 (B) og https://www.ssb.no/statbank/table/09429 (K)
...
tabell_50_kommune <- read_delim("datauttrekk_raw/tabell_50_kommune.csv", ";", escape_double = FALSE, 
                               col_types = cols(Region = col_character(),
                                                Tid = col_character()), 
                               locale = locale(decimal_mark = ",", grouping_mark = " "), 
                               trim_ws = TRUE)

tabell_50_bydel <- read_delim("datauttrekk_raw/tabell_50_bydel.csv", ";", escape_double = FALSE, 
                                col_types = cols(Region = col_character(),
                                                 Tid = col_character()), 
                                locale = locale(decimal_mark = ",", grouping_mark = " "), 
                                trim_ws = TRUE)
...
temp = bind_rows(rename(tabell_50_kommune, UtdNivaa = Nivaa), tabell_50_bydel)
...
#for tabell 1 og 45, 47, 50 returnerer API-et 0 for enheter som ikke lenger finnes 
...
##ssb_07459 og ssb_10826 har avvikende bydelskoding - 030101a fra og med 2004. Utdanningstabellene også.
...
temp = mutate(temp, 
              Variabel = "v50_antall_utdanning_over_grunnskole",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v50_antall_utdanning_over_grunnskole.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_50_bydel, tabell_50_kommune,
