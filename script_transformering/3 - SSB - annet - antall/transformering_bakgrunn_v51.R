...
tabell_51_kommune <- read_delim("datauttrekk_raw/tabell_51_kommune.csv", ";", escape_double = FALSE, 
                               col_types = cols(Region = col_character(),
                                                Tid = col_character()), 
                               locale = locale(decimal_mark = ",", grouping_mark = " "), 
                               trim_ws = TRUE)

tabell_51_bydel <- read_delim("datauttrekk_raw/tabell_51_bydel.csv", ";", escape_double = FALSE, 
                                col_types = cols(Region = col_character(),
                                                 Tid = col_character()), 
                                locale = locale(decimal_mark = ",", grouping_mark = " "), 
                                trim_ws = TRUE)
...
temp = mutate(temp, 
              Variabel = "v51_antall_personer_over16",
              Tallformat = "Antall"
)
...
write.csv2(temp, "data_bearbeida/v51_antall_personer_over16.csv", row.names = FALSE)
...
rm(historiske_bydelsnr, historiske_fylkesnr, historiske_kommunekoder,
   ...
   metadata_geografi_alle, metadata_iks, tabell_51_bydel, tabell_51_kommune,
